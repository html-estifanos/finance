...
<?php 
$sql="SELECT DISTINCT account_type FROM record order by account_type";
...
if ($result->num_rows > 0) 
{
    ...
    <table border=2>
        ...
        <?php
        $sql2="SELECT * FROM record WHERE account_type=' $id ' ";
        $result2 = $conn->query($sql2);
...
<tr>
  ...
  <?php
        ...
        ?>
    <tr style="background-color:red"> <td > total balance </td><td></td><td></td><td><?php echo $debit?></td><td><?php echo $credit?></td>
    <td > <?php echo $balance?> </td></tr></table></br>
        <?php
    }
}
